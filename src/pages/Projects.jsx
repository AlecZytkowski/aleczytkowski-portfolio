...
export const Projects = () => {
    ...
    return (
        <div className='projects' id='projects'>
            ...
            <ProjectCard project={{ name: 'ShopATM', description: 'Shop ATM is a front-end e-commerce project that demonstrates web development skills, and knowledge in ReactJS. Users can browse a variety of different products, add items to their cart, and view the total cost. The site features a responsive design and smooth interactions for a seamless shopping experience.', websiteUrl: 'https://aleczytkowski.github.io/shop-atm/', githubUrl:'https://github.com/AlecZytkowski/ShopATM'}}/>
